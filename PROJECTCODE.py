...
class RFIDBillApp:
    ...
    def send_mail(self):
        ...
        # Here, you can add any message you want to display when the "Send Mail" button is clicked,
        # without actually sending an email.
        #messagebox.showinfo("Info", "Mail sending is disabled for this application.")
